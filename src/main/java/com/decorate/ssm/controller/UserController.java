...
*/
    ...
    @ResponseBody
    public DecorateMessage deleteUser(String users_id) throws Exception {
        String[] ids = users_id.split("-");

        if (users_id.contains("-")) {
            ...
            Integer id = Integer.parseInt(users_id);
            userService.deleteUser(id);
            return DecorateMessage.success();
        }
    ...
    public @ResponseBody
    UserCustom resultJson(@PathVariable("id") Integer id) throws Exception {
